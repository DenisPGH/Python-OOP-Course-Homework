""" in this task, have to rename the name of the def in each child class, so they can be used by
callin in additional function-polimorphism number_of_robot_sensors"""
