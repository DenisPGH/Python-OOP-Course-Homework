...
Upon initialization, the Customer class should receive the following
 parameters: name: str, age: int, id: int. Each customer should also have an instance attribute
 called rented_dvds (empty list with DVD instances).
...
class Customer:
    def __init__(self,name,age,id):
        ...
        self.age = age
        self.id = id
        self.rented_dvds=[] # store dvd instance
